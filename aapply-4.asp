...
<div class="am-form-group">
            ...
            <a href="xgwl/pdf/2019-2020-financial-guarantee-form.pdf" target="_blank">[Download]2019-2020 financial-guarantee-form.pdf</a><br>
            <a href="xgwl/pdf/sevis-transfer-form_9-10-18.pdf" target="_blank">[Download]sevis-transfer-form_9-10-18.pdf</a><br>
             reference:<br>
            <a href="xgwl/pdf/Masters-programs-adminssion-requirement_10-20-18.pdf" target="_blank">[Download]Masters-programs-adminssion-requirement_10-20-18.pdf</a>
            </div>
            <div class="am-form-group">
...
<div class="am-form-group">
<label class="am-checkbox">
                <input type="checkbox"  value="YES" name="d11" class="d11" <%if d11="YES" then%> checked<%end if%>> I certify that all the information supplied in this form is correct and complete, and understand that any misrepresentation or falsification, including failure to report any college or university attendance, is sufficient cause for cancellation of enrollment and/or credits earned and could result in other disciplinary action. I authorize ASUMENTOR to supply any relevant records relating to my attendance and progress, including personal records, contact details, and disciplinary records, to ASUMENTOR's employees, staff, affiliates, agents, representatives, and others working on ASUMENTOR’s behalf, as well as to the U.S. Department of Homeland Security, state and accrediting agencies, the University, my parents, guardian, or sponsor. I hereby consent to you contacting any school or institution at which I have previously studied in order to verify the information I have provided in the application and hereby authorize such school or institution to disclose such information.
            </label>
</div>
