...
(function ($) {
	...
	$.mobiscroll.i18n.zh = $.extend($.mobiscroll.i18n.zh, {
			...
			dateOrder: 'yymmdd',
			dayNames: ['周日', '周一;', '周二;', '周三', '周四', '周五', '周六'],//['周日', '周一;', '周二;', '周三', '周四', '周五', '周六']
			dayNamesShort: ['日', '一', '二', '三', '四', '五', '六'],//['日', '一', '二', '三', '四', '五', '六']
			dayText: '日',//日
			hourText: '时',//时
			minuteText: '分',//分
			monthNames: ['一月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'],//['一月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月']
			monthNamesShort: ['1月', '2月', '3月', '4月', '5月', '6月', '7月', '8月', '9月', '10月', '11月', '12月'],//['1月', '2月', '3月', '4月', '5月', '6月', '7月', '8月', '9月', '10月', '11月', '12月']
			monthText: '月',//月
			secText: '秒',//秒
			timeFormat: 'HH:ii',
			timeWheels: 'HHii',
